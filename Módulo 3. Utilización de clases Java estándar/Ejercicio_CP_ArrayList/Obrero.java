...
public class Obrero extends Empleado{
    ...
    //2ºConstructor que recibe como parámetro otro objeto de la clase Obrero
    public Obrero(Obrero oObrero){
        super(oObrero);//con super llamamos al constructor de la clase Empleado
        turno = oObrero.turno;
        horas_trabajadas = oObrero.horas_trabajadas;
        horas_trabajadas = oObrero.horas_trabajadas;
    }
    
    //3ºConstructor que recibe como parámetro otro objeto de la clase Empleado  y un dato para cada dato de Obrero
    public Obrero(Empleado oEmpleado, String turno, int horas_trabajadas, int horas_extras) {
    ...
    public Obrero(String nombre, byte edad, char sexo, String dni, boolean bCasado, String idPersonal, float sueldo, String turno, int horas_trabajadas, int horas_extras) {
    ...
    public String toString(){
        return "[Persona] = El nombre es " + this.getNombre() + ", la edad es " + this.getEdad() + 
            ...
            + this.getSueldo() + ", [Obrero] sus turno es de " + this.getTurno() + " , su horas de trabajo diarias son "
    ...
    protected Object clone() throws CloneNotSupportedException {
        return new Obrero(this.getNombre(), this.getEdad(), this.getSexo(), this.getDni(), this.getBCasado(), this.getIdPersonal(), this.getSueldo(), this.getTurno(), this.getHoras_trabajadas(), this.getHoras_extras());
    }
